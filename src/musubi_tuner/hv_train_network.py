    ...
    def get_noisy_model_input_and_timesteps(
        ...
        if (
            ...
            kl_optimal_dict = {
                ...
                "kl_optimal_50": [
                    0.99999, 0.96846, 0.93788, 0.90821, 0.87939,
